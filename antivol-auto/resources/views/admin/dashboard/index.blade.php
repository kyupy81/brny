<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <!-- Filters -->
            <x-dashboard-filters :filters="$filters" :communes="$communes" :brands="$brands" :agents="$agents" />
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mb-8">
                <div class="px-6 py-4 border-b border-gray-200 font-bold">Performance des Agents</div>
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-gray-200 text-sm">
                        <thead class="bg-gray-50">
                            <tr>
                                <th class="px-4 py-2 text-left">Agent</th>
                                <th class="px-4 py-2 text-right">Total Dossiers</th>
                                <th class="px-4 py-2 text-right">Volés</th>
                                <th class="px-4 py-2 text-right">Taux Vol</th>
                            </tr>
                        </thead>
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <tr>
                                ...
                                <td class="px-4 py-2 text-right">{{ $agent->total }}</td>
                                <td class="px-4 py-2 text-right text-red-600">{{ $agent->stolen_count }}</td>
                                <td class="px-4 py-2 text-right">{{ $agent->stolen_rate }}%</td>
                            </tr>
                            @endforeach
                        </tbody>
                    </table>
